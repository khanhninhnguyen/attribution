...
remove_cluster <- function(path_results, nb_test.ref, criterion, window.thres, nearby_ver){
  ...
  data <- get(load(file = paste0(path_results,"attribution/vertical_correction/six_diff_series_",window.thres,"year_", nearby_ver,"0.RData")))
  ...
  save(short.list, file = paste0(path_results,"attribution/check_homo/removed_possible_crenel_",window.thres,"year_", nearby_ver,".RData"))
  save(data, file = paste0(path_results,"attribution/check_homo/six_diff_series_rm_crenel_", window.thres,"year_",nearby_ver,".RData"))
...
# Remove all breakpoint in +/- thres years excluding the crenel different restriction for different test----------------

check_homo <- function(path_results,window.thres, nearby_ver, criterion){
  
  list.cre = get(load(file = paste0(path_results,"attribution/check_homo/removed_possible_crenel_",window.thres,"year_", nearby_ver,".RData")))
  meta.compare.near =  get(load(file = paste0(path_results,"validation/",nb_test.near,"-",criterion,"metacompa",screen.value="",".RData")))
  meta.compare =  get(load(file = paste0(path_results,"validation/",nb_test.ref,"-",criterion,"metacompa",screen.value="",".RData")))
  
  data.cr <- get(load(file = paste0(path_results,"attribution/check_homo/six_diff_series_rm_crenel_",window.thres,"year_", nearby_ver,".RData")))
  ...
  save(last.list.remove, file = paste0(path_results,"attribution/check_homo/restricted_by_closed_brp_",window.thres,"year_", nearby_ver,".RData"))
  save(data.cr, file = paste0(path_results,"attribution/check_homo/six_diff_series_rm_crenel_restricted_closed_brp_",window.thres,"year_", nearby_ver,".RData"))
